...
class HomeController extends Controller
{
    ...
    public function home()
    {
        ...
        $order = Order_item::groupBy('product_name')->groupBy('product_id')->select('product_name', 'product_id','product_image', 'product_price', Order_item::raw('sum(product_quantity) as total'))->having('total', '>', 1)->orderBy('total', 'desc')->paginate(10);
        ...
        return view('admin/home', compact('order', 'orderData'), $viewData);
    }
