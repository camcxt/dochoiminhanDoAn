                ...
                <div class="span12">
                    <div class="widget ">
                        ...
                        <div class="widget-content">
                            <form action="{{ route('updateBrand', $brand->id) }}" enctype="multipart/form-data"
                                ...
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            @if ($errors->any())
                                                <input class="span3" name="link" value="{!! old('link') !!}"
                                                    type="text" />
                                            @else
                                                <input type="text" class="span3" name="link"
                                                    value="{{ $brand->link }}">
                                            @endif
                                            @error('link')
                                                <br>
                                    ...
                                    <div class="control-group">
                                        <div class="controls">
                                            <img width="60px" height="60px" src="../images/{{ $brand->image_url }}"
                                                alt="">
                                        </div> <!-- /controls -->
                                    </div> <!-- /control-group -->
